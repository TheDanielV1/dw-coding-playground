...
const fiveSyllables = [
  ...
  "Silent as the grave",
  "Bow before me now",
  "Will you seek judgment?",
  "Can I try again?",
  "Fight and kill the heart",
  "Architect of lies",
];
const sevenSyllables = [
  "A simple pawn in the game",
  "Should get to choose how you die",
  "Wax wings crumble beneath me",
  "All hope is lost to the wind",
  "For eternity I sleep",
];
...
const words = [
  ...
  "armor is a prison",
  "a king is only as strong as his subjects",

  "blades cut meat and bone",
  "balls of light and darkness",
  "break upon the wheel of time",

  "cry out in anger",
  "careful to not become the monster you fight",
  "caring is a weakness",

  "destruction is esctatic",
  "delusional jealousy",
  "don't let them know you care",

  "earliest memories as a child",
  "evil is the root of all suffering",
